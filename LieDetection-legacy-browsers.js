...
function trials_instruct_numLoopBegin(trials_instruct_numLoopScheduler) {
  ...
  trials_instruct_num.forEach(function() {
...
function trials_instruct_questLoopBegin(trials_instruct_questLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trials_instruct_quest.forEach(function() {
...
function NumberTestRoutineBegin(snapshot) {
  return function () {
    ...
    NumberTestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instructions_QuestRoutineBegin(snapshot) {
  return function () {
    ...
    Instructions_QuestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function QuestionsTestRoutineBegin(snapshot) {
  return function () {
    ...
    QuestionsTestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
